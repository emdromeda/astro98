...
variable4 = g # Data type of variable4: bone
...
# normal division: just divides the two numbers; returns a float
# floor division: divides the two numbers then returns integer without remainder 
# modulo division: divides the two numbers then returns the remainder (in integer)
